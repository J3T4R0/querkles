...
(define (localmaxima-band band [eight_connectivity #t] [marker 1.0] [threshold -inf.0] [allow_at_border #f] [allow_plateaus #f] [plateau_epsilon 0.001])
  (let* ((width  (band-width  band))
         (height (band-height band))
         (band2  (make-band width height 0.0))
...
(define (localmaxima image [eight_connectivity #t] [marker 1.0] [threshold -inf.0] [allow_at_border #f] [allow_plateaus #f] [plateau_epsilon 0.001])
...
(define (localminima-band band [eight_connectivity #t] [marker 1.0] [threshold +inf.0] [allow_at_border #f] [allow_plateaus #f] [plateau_epsilon 0.001])
  (let* ((width  (band-width  band))
         (height (band-height band))
	 	 (band2 (make-band width height 0.0))
...
(define (localminima image [eight_connectivity #t] [marker 1.0] [threshold +inf.0] [allow_at_border #f] [allow_plateaus #f] [plateau_epsilon 0.0001])
